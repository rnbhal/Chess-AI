...
class Searcher:
    ...
    def bound(self, pos, gamma, depth, root=True):
        ...
        # Depth <= 0 is QSearch. Here any position is searched as deeply as is needed for calmness, and so there is no reason
        # to keep different depths in the transposition table.
        depth = max(depth, 0)
        ...
        def moves():
            ...
            # Then killer move. We search it twice, but the tp will fix things for us. Note,
            # we don't have to check for legality, since we've already done it before.
